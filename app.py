...
with tab2:
    ...
    bl_file = st.file_uploader("3. House/Master B/L", type="pdf")
    ...
    if not inv_file or not pl_file or not nomor_aju:
        ...
        with st.spinner("Memproses data..."):
            try:
                ...
                # --- EXCEL GENERATION ---
                output = io.BytesIO()
                with pd.ExcelWriter(output, engine="openpyxl") as writer: # FIXED ENGINE
                    sheets = [
